...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
  <ul>
    ...
    <li class="active"><a href="/duobao/admin.php/Index/index.html"><i class="icon icon-th"></i> <span>开奖统计</span></a></li>
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
			  ...
			  <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr class="gradeX">
                  ...
                  <td style="text-align:center">￥<?php echo ($v['number']*12); ?>.00</td>
					  <?php if($v['success']==1): ?><td style="text-align:center"><span style="color:red">获胜</span></td>
					  <td style="text-align:center">-<span style="color:green">￥<?php echo ($v['number']*8); ?></span></td>
					  <?php elseif($v['success']==0): ?>
					  <td style="text-align:center"><span style="color:green">失败</span></td>
					  <td style="text-align:center">+<span style="color:red">￥<?php echo ($v['number']*12); ?></span></td><?php endif; ?>
				  <?php elseif($v['goods_id']==8): ?>
				  <td style="text-align:center"><span style="color:#14ed44">50</span>元充值卡</td>
				  <td style="text-align:center"><?php echo ($v["number"]); ?></td>
                  <td style="text-align:center">￥<?php echo ($v['number']*28); ?>.00</td>
					  <?php if($v['success']==1): ?><td style="text-align:center"><span style="color:red">获胜</span></td>
					  <td style="text-align:center">-<span style="color:green">￥<?php echo ($v['number']*22); ?></span></td>
					  <?php elseif($v['success']==0): ?>
					  <td style="text-align:center"><span style="color:green">失败</span></td>
					  <td style="text-align:center">+<span style="color:red">￥<?php echo ($v['number']*28); ?></span></td><?php endif; ?>
				  <?php elseif($v['goods_id']==12): ?>
				  <td style="text-align:center"><span style="color:#f50e53">100</span>元充值卡</td>
				  <td style="text-align:center"><?php echo ($v["number"]); ?></td>
                  <td style="text-align:center">￥<?php echo ($v['number']*55); ?>.00</td>
					  <?php if($v['success']==1): ?><td style="text-align:center"><span style="color:red">获胜</span></td>
					  <td style="text-align:center">-<span style="color:green">￥<?php echo ($v['number']*45); ?></span></td>
					  <?php elseif($v['success']==0): ?>
					  <td style="text-align:center"><span style="color:green">失败</span></td>
					  <td style="text-align:center">+<span style="color:red">￥<?php echo ($v['number']*55); ?></span></td><?php endif; endif; ?>
