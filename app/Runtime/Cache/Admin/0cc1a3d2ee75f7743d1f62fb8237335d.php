    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/duobao/admin.php/Index/update2/id/<?php echo ($info["id"]); ?>" method="post" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">用户名 :</label>
              <div class="controls">
                <input type="text" class="span11" name="user_name" value="<?php echo ($info["user_name"]); ?>" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">开奖状态( '1' 为已开奖) :</label>
              <div class="controls">
                <input type="text" class="span11" name="controller"  value="<?php echo ($info["controller"]); ?>" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">获胜状态( '1' 为获胜) :</label>
              <div class="controls">
                <input type="text"  class="span11" name="success"  value="<?php echo ($info["success"]); ?>"   />
              </div>
            </div>
