...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
  <ul>
    ...
    <li class="active"><a href="/duobao/admin.php/Index/date_number.html"><i class="icon icon-fullscreen"></i> <span>开奖记录</span></a></li>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
              <?php if(is_array($award)): foreach($award as $k=>$v): ?><tr class="gradeX">
				  <td  style="text-align:center"><?php echo ($k+1); ?></td>
                  <td style="text-align:center"><?php echo ($v["date_number"]); ?></td>
                  <td style="text-align:center"><?php echo ($v["award_number"]); ?></td>
                  <td style="text-align:center"><?php echo ($v["award_time"]); ?></td>
                  <?php if($v['award_number']%2==0): ?><td class="center" style="color:red;text-align:center">买双</td>
                  <?php else: ?>
                  <td class="center" style="color:green;text-align:center">买单</td><?php endif; ?>
         <td><a href="/duobao/admin.php/Index/update_index/id/<?php echo ($v["id"]); ?>">修改</a> / <a href="/duobao/admin.php/Index/add_datenumber">添加</a> /<a href="javascript:void();" onclick="del(<?php echo ($v["id"]); ?>)">删除</a></td>
		 <!-- <a href="javascript:void();" onclick="del(<?php echo ($v["id"]); ?>)">删除</a> -->
