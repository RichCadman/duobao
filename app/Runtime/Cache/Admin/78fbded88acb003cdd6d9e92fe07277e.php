...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
  <ul>
	...
	<li class="active"><a href="/duobao/admin.php/Index/chongzhi.html"><i class="icon icon-fullscreen"></i> <span>充值记录</span></a></li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 主页</a> <a href="#" class="current">充值记录</a> </div>
    <h1>充值记录</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
              <?php if(is_array($chongzhi)): foreach($chongzhi as $k=>$v): ?><tr class="gradeX" >
				  <td style="text-align:center"><?php echo ($k+1); ?></td>
                  <td style="text-align:center"><?php echo ($v["cz_name"]); ?></td>
                  <td style="text-align:center;color:red">￥<?php echo ($v["jine"]); ?>.00</td>
                  <td style="text-align:center"><?php echo date("Y-m-d H:i:s",$v['cz_time']);?></td>
