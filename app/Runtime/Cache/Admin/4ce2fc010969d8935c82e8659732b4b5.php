    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/bocai/admin.php/Index/update/id/<?php echo ($info["id"]); ?>" method="post" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">时时彩期号 :</label>
              <div class="controls">
                <input type="text" class="span11" name="date_number" value="<?php echo ($info["date_number"]); ?>" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">中奖号码 :</label>
              <div class="controls">
                <input type="text" class="span11" name="award_number"  value="<?php echo ($info["award_number"]); ?>" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">开奖时间 :</label>
              <div class="controls">
                <input type="text"  class="span11" name="award_time"  value="<?php echo ($info["award_time"]); ?>"   />
              </div>
            </div>
