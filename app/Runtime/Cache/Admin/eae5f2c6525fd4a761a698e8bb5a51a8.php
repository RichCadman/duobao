...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
  <ul>
	...
	<li class="active"><a href="/duobao/admin.php/Index/tixian.html"><i class="icon icon-fullscreen"></i> <span>提现记录</span></a></li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 主页</a> <a href="#" class="current">提现记录</a> </div>
    <h1>提现记录</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
              <?php if(is_array($tixian)): foreach($tixian as $k=>$v): ?><tr class="gradeX" >
				  <td style="text-align:center"><?php echo ($k+1); ?></td>
                  <td style="text-align:center"><?php echo ($v["tx_name"]); ?></td>
                  <td style="text-align:center"><?php echo ($v["user_id"]); ?></td>
				  <?php if($v['type']==1): ?><td style="text-align:center;color:red">￥<?php echo ($v["record"]); ?>.00</td>
				  <td style="text-align:center;color:red">今日首单</td>
				  <td style="text-align:center;color:green">￥<?php echo ($v["record"]); ?>.00</td>
				  <?php else: ?>
				  <td style="text-align:center;color:red">￥<?php echo ($v["record"]); ?>.00</td>
				  <td style="text-align:center;color:green">多次提现</td>
				  <td style="text-align:center;color:green">￥<?php echo ($v['record']-2); ?>.00</td><?php endif; ?>
                  
                  <td style="text-align:center"><?php echo date("Y-m-d H:i:s",$v['withdraw_time']);?></td>
                  
                  </if>
          <!-- <td><a href="/duobao/admin.php/Index/update_index/id/<?php echo ($v["id"]); ?>">修改</a> / <a href="javascript:void();" onclick="del(<?php echo ($v["id"]); ?>)">删除</a></td> -->
