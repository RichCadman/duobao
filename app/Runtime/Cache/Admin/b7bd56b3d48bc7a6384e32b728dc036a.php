...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">修改用户</a>  </div>
  <h1>修改用户</h1>
</div>
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/duobao/admin.php/Index/update_user/id/<?php echo ($info["id"]); ?>" method="post" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">用户名 :</label>
              <div class="controls">
                <input type="text" class="span11" disabled='disabled' value="<?php echo ($info["user_name"]); ?>" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">金额 :</label>
              <div class="controls">
                <input type="text" class="span11" name="money"  value="<?php echo ($info["money"]); ?>" />
              </div>
            </div>
